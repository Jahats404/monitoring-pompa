...
<body>
	...
	<nav class="navbar navbar-expand navbar-dark absolute-top w-100 py-2">
		<div class="container">
			...
			<a class="btn btn-success btn-pill my-2 ms-2" href="https://themes.getbootstrap.com/product/spark-responsive-admin-template/" target="_blank">
				Purchase Now
			</a>
		</div>
	</nav>
					...
					<div class="row">
						<div class="col-md-12 col-xl-8 text-center mx-auto">
							<div class="d-block my-4">
								<h1 class="display-4 fw-bold mb-3 text-white">Modern, Flexible and Responsive Bootstrap 5 Admin Template</h1>
								...
								<div class="my-4">
									<img src="img/brands/bootstrap.png" alt="Bootstrap" width="50" class="align-middle me-2" />
									<img src="img/brands/sass.svg" alt="Sass" width="40" class="align-middle me-2" />
									<img src="img/brands/webpack.svg" alt="Webpack" width="40" class="align-middle me-2" />
									<img src="img/brands/npm.svg" alt="NPM" width="40" class="align-middle" />
								</div>
							</div>
						</div>
					</div>
	...
	<section class="py-6 bg-white">
		<div class="container">
			...
			<div class="mb-4 text-center">
				<h2>Testimonials</h2>
				<p class="text-muted">Here's what some of our 5,000+ customers have to say about working with our products.</p>
			</div>
