...
return new class extends Migration
{
    ...
    {
        Schema::create('standar_charging_pump', function (Blueprint $table) {
            $table->string('id_standar_charging_pump')->primary()->unique();
    ...
    {
        Schema::dropIfExists('standar_charging_pump');
    }
};